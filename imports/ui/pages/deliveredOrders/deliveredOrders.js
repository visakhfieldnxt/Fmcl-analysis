...
Template.deliveredOrders.onCreated(function () {
  const self = this;
  self.autorun(() => {
  });
...
Template.deliveredOrders.onRendered(function () {
...
Template.deliveredOrders.helpers({
...
Template.deliveredOrders.events({
  /** 
 * TODO:Complete JS doc
 * @param event
 */
  ...
  'click .view': (event, template) => {
    ...
    let detailDeliveredDate = $('#detailDeliveredDate');
    let detailDeliveryRemarks = $('#detailDeliveryRemarks');
    ...
    Meteor.call('order.orderData', id, (error, res) => {
      if (!error) {
        ...
        $(detailApprovedBy).html(res.approvedByName);
        $(detailRemarks).html(order.approvalRemark);
        $(detailDeliveredDate).html(moment(order.deliveredDate).format('DD-MM-YYYY'));
        $(detailDeliveryRemarks).html(order.deliveryRemarks);
        ...
        $(approvedDate).html(moment(order.approvedDate).format('DD-MM-YYYY hh:mm A'));
